...
public class Questionire1 {
    ...
    Qusestionire que1 = new Qusestionire();
    ...
    public void initialize() {
        ...
        q1.setOpacity(0.7);
        q1.setStyle("-fx-text-fill: #EEEEEE");

        // textfield to enter name
        q1TextField = new TextField(que1.getName());
        ...
        nextButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    // Capture user input
                    String name = q1TextField.getText();
                    ...
                    DataService.addquestiondata(Login.loggedinUserName, data, "name");
        ...
        hb.setStyle("-fx-background-color: #222831");
        hb.setMinWidth(1500);
