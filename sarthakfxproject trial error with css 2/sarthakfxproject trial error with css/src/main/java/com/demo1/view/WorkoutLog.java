...
public class WorkoutLog {
    ...
    public void initialize() {
        ...
        // VBox defaultworkoutVBox = new VBox(wlog, horizontalline1light, imageView);
        ...
        // rightvbox
        VBox righvBox = new VBox(wlog, horizontalline1light, imageView); // BEFORE : Forhbox,defaultworkoutVBox
        righvBox.setPrefHeight(1000);
        righvBox.setPrefWidth(550);
        righvBox.setStyle("-fx-background-color: #00ADB5;");
        righvBox.setPadding(new Insets(10, 30, 0, 10));
        righvBox.setSpacing(10);
        righvBox.setAlignment(Pos.CENTER);
        ...
        customworkoutVBox.setStyle(" -fx-background-color:#00ADB5;" + "-fx-background-radius: 20px;");
        ...
        submit.getStyleClass().add("rounded-customworkout-custom-button");

        Button back = new Button("Back");
        back.setFont(Font.font("Montserrat", 20));
        back.setPadding(new Insets(10, 0, 10, 0));
        back.getStyleClass().add("rounded-customworkout-custom-button");
        ...
        leftVBox.setStyle("-fx-background-color:#222831;");
        leftVBox.setPadding(new Insets(20, 20, 20, 20));
        leftVBox.setSpacing(20);

        // mainhbox
        HBox mainhBox = new HBox(righvBox, leftVBox);
        mainhBox.setPrefHeight(1000);
        mainhBox.setPrefWidth(1500);
        mainhBox.setStyle("-fx-background-color: #222831");
