...
public class History {
    ...
    private Group group;
    private String logUsern;

    public History(Navigation nav, String username) {
        this.logUsern = username;
    ...
    private VBox loadFoodDetails() {
        ...
        try {
            ...
            // String username = "sam"; // Replace this with actual logic to get the
            // logged-in username
            List<DocumentSnapshot> dietDocuments = dataService.getUserDataInDescendingOrder(logUsern, "diets",
                    "timestamp");
    ...
    private VBox loadWorkoutDetails() {
        ...
        System.out.println("work1" + logUsern);
        System.out.println("work1 log" + logUsern);
        // Login usr = new Login(nav);
        vbox.setSpacing(10);
        try {
            vbox.getChildren().clear();
            System.out.println("work2" + logUsern);

            // String username = "sam"; // Replace this with actual logic to get the
            // logged-in username
            List<DocumentSnapshot> workoutDocuments = dataService.getUserDataInDescendingOrder(logUsern,
                    "workouts",
                    "timestamp");
