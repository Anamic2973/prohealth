...
public class DietLogbook{
    ...
    public void initialize() {
        ...
        Label breakfastcal = new Label("(0)");
        ...
        breakf.setPadding(new Insets(0, 0, 0, 0));
        ...
        breakfastBox.setPadding(new Insets(0, 0, 0, 0));
        ...
        lunchHBox.setPadding(new Insets(0, 0, 10, 40));
        ...
        // Right VBox
        VBox lbr = new VBox(bVBox, lVBox,dVBox);
        lbr.setPrefWidth(1030);
        lbr.setPrefHeight(820);
        lbr.setPadding(new Insets(0));
