...
public class Profile {
        ...
        public void initialize() {
                ...
                HBox rightContent1 = new HBox(headlabel, saveButton);
                ...
                rightContent1.setPadding(new Insets(20, 20, 20, 20)); // Add padding around the HBox
                ...
                data.getChildren().addAll(hBox1, hBox2, hBox3);
